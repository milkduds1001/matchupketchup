 ...
 * adjustment to make (see matchupCardAdjust.js). Always a single card copy — this page's
 * multi-card selection/drag was removed (see git history if it's ever wanted back), so there's no
 * multi-payload variant anymore.
 *
